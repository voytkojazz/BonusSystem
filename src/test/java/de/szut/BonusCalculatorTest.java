...
class BonusCalculatorTest {
    ...
    /**
     * Test implementation of Employee for testing purposes.
     */
    static class TestEmployee implements Employee {
        ...
        public TestEmployee(String name, int yearsAtCompany, int performanceScore,
                            int completedProjects, int absenceDays, boolean teamLeader) {
            this.name = name;
    ...
    void testEmployeeA() {
        ...
        Employee employeeA = new TestEmployee("A", 6, 50, 2, 2, false);
    ...
    void testEmployeeB() {
        ...
        Employee employeeB = new TestEmployee("B", 12, 80, 5, 16, true);
    ...
    void testBaseBonus() {
        ...
        Employee employee = new TestEmployee("John", 0, 20, 0, 20, false);
    ...
    void testSeniorityBonus() {
        ...
        Employee fourYears = new TestEmployee("Four", 4, 50, 0, 5, false);
        ...
        Employee fiveYears = new TestEmployee("Five", 5, 50, 0, 5, false);
        ...
        Employee elevenYears = new TestEmployee("Eleven", 11, 50, 0, 5, false);
    ...
    void testTeamLeaderBonus() {
        ...
        Employee teamLeader = new TestEmployee("Leader", 2, 30, 0, 5, true);
        ...
        Employee nonLeader = new TestEmployee("NonLeader", 2, 30, 0, 5, false);
    ...
    void testAbsenceBonusAndPenalty() {
        ...
        Employee lowAbsence1 = new TestEmployee("Low1", 0, 50, 0, 2, false);
        ...
        Employee lowAbsence2 = new TestEmployee("Low2", 0, 50, 0, 7, false);
        ...
        Employee highAbsence1 = new TestEmployee("High1", 10, 50, 0, 17, false);
        ...
        Employee highAbsence2 = new TestEmployee("High2", 10, 50, 0, 30, false);
    ...
    void testPerformanceMultiplier() {
        // Low performance (< 33)
        Employee lowPerformance = new TestEmployee("LowPerf", 0, 20, 0, 4, false);
        double lowPerfBonus = calculator.calculate(lowPerformance);
        // Base 300 * 1.07 = 321, below min so 500
        assertEquals(500.0, lowPerfBonus, 0.01);

        // Medium performance (33-66)
        Employee medPerformance = new TestEmployee("MedPerf", 0, 50, 5, 4, false);
        ...
        // High performance (> 66)
        Employee highPerformance = new TestEmployee("HighPerf", 0, 80, 5, 4, false);
    ...
    void testMinMaxBoundaries() {
        // Test max boundary
        Employee maxEmployee = new TestEmployee("Max", 30, 90, 15, 0, true);
        ...
        // Test min boundary
        Employee minEmployee = new TestEmployee("Min", 0, 10, 0, 30, false);
    ...
    void testCustomBonusChain() {
        ...
        Employee employee = new TestEmployee("Custom", 5, 80, 3, 0, false);
